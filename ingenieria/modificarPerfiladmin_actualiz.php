...
<body>
	...
	mysqli_query($conexion, "UPDATE administrador
		set nombre='$_REQUEST[nombrenuevo]', apellido='$_REQUEST[apellidonuevo]',telefono='$_REQUEST[numeronuevo]',nacimiento='$_REQUEST[fechanueva]',clave='$_REQUEST[clavenueva]'WHERE correo='$correo'");
	?>

	<script type="text/javascript">
                alert("El administrador ha sido modificado con exito! Ingrese a su sesion nuevamente");
