...
<body>
	...
	session_start();
	$id_usuario=$_POST['secreto'];
	mysqli_query($conexion, "UPDATE usuario
		set nombre='$_REQUEST[nombrenuevo]', apellido='$_REQUEST[apellidonuevo]',telefono='$_REQUEST[numeronuevo]',nacimiento='$_REQUEST[fechanueva]',clave='$_REQUEST[clavenueva]'WHERE id_usuario='$id_usuario'");
	?>

	<script type="text/javascript">
                alert("El usuario ha sido modificado con exito!");
                window.location="modificarPerfilUsuarios.php"
                </script>';
	<br><br>
</body>
</html>